  ...
  describe('#parse()', () => {
    describe('errors', () => {
      it('throws on empty documents', () => {
        ...
        err => (
          err instanceof SyntaxError &&
                    /^JSON6: invalid end of input/.test(err.message) &&
                    err.lineNumber === 1 &&
                    err.columnNumber === 1
        ));
      });
      ...
      it('throws on incomplete single line comments', () => {
        ...
        err => (
          err instanceof SyntaxError &&
                    /^JSON6: invalid character 'a'/.test(err.message) &&
                    err.lineNumber === 1 &&
                    err.columnNumber === 2
        ));
      });
      ...
      it('throws on invalid identifier start characters', () => {
        ...
        err => (
          err instanceof SyntaxError &&
                    /^JSON6: invalid identifier character/.test(err.message) &&
                    err.lineNumber === 1 &&
                    err.columnNumber === 2
        ));
      });
      ...
      it('throws on invalid characters following a hexidecimal indicator', () => {
        ...
        err => (
          err instanceof SyntaxError &&
                    /^JSON6: invalid character 'g'/.test(err.message) &&
                    err.lineNumber === 1 &&
                    err.columnNumber === 3
        ));
      });
      ...
      it('throws on invalid characters following a binary indicator', () => {
        ...
        err => (
          err instanceof SyntaxError &&
                    /^JSON6: invalid character '2'/.test(err.message) &&
                    err.lineNumber === 1 &&
                    err.columnNumber === 3
        ));
      });
      ...
      it('throws on escaped digits other than 0', () => {
        for (let i = 1; i <= 9; i++) {
          ...
          err => (
            err instanceof SyntaxError &&
                        /^JSON6: invalid character '\d'/.test(err.message) &&
                        err.lineNumber === 1 &&
                        err.columnNumber === 3
          ));
        }
      ...
      it('throws on octal escapes', () => {
        ...
        err => (
          err instanceof SyntaxError &&
                    /^JSON6: invalid character '1'/.test(err.message) &&
                    err.lineNumber === 1 &&
                    err.columnNumber === 4
        ));
      });
      ...
      it('throws with control characters escaped in the message', () => {
        ...
        err => (
          err instanceof SyntaxError &&
                    /^JSON6: invalid character '\\x01'/.test(err.message) &&
                    err.lineNumber === 1 &&
                    err.columnNumber === 1
        ));
      });
